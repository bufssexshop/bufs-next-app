...
const buttonVariants = {
  primary: 'text-sm bg-customPink dark:bg-darkPink text-white hover:opacity-80 duration-500',
...
const disabledStyles = 'bg-slate-500 dark:bg-slate-400 hover:opacity-100 cursor-not-allowed'
