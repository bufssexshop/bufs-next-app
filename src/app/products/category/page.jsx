...
const Products = () => {
  ...
  }, [currentCategory, category, setCategory, subcategory, setSubcategory])
  ...
  const productsQuery = useQuery({
    queryKey: ['hydrate-users', category, currentPage, itemsPerPage],
    queryFn: () => getData(`productos/getCategoryProducts/${category}?page=${currentPage}&limit=${itemsPerPage}`),
    enabled: true,
    onSuccess: () => {
      ...
      <section>
        ...
        {sortedProducts.length > 0 && (
          <div className='w-full'>
            ...
            <div className='grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 xs:gap-3 gap-8'>
              {sortedProducts
